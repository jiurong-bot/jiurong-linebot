...
// 使用 V15.0 的 reply 函式，支援 Quick Reply
...
function getNextDate(dayOfWeek, timeStr, startDate = new Date()) {
    ...
    resultDate.setUTCHours(hours - 8, minutes, 0, 0); // 設置為台北時間
