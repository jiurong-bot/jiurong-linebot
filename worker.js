...
let lastDataCleanup = 0; // [新增] 上次執行資料清理的時間戳
let isAlertCooldown = false; // [新增] 智慧警報是否在冷卻中
...
async function main() {
  console.log('🚀 背景工作程式 (Worker) 已啟動... V36.0 (整合清理與警報功能)');
  while (true) {
    if (isShuttingDown) {
