// index.js - V4.9.28 (只移除指定老師選單 Quick Reply)
...
// =====================================
const teacherMenu = [
    { type: 'postback', label: '切換身份', data: `action=run_command&text=${COMMANDS.SWITCH_ROLE}` }
];
...
app.listen(PORT, async () => {
  ...
  console.log(`Bot 版本: V4.9.28 (只移除指定老師選單 Quick Reply)`);
