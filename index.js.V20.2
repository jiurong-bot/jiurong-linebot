/*
 * index.js - V20.2 (終極偵錯版)
 * =================================================================
 * 功能簡介 (Functional Overview):
 * - 加入了最詳細的 Webhook 請求日誌，用於追蹤簽章驗證階段的潛在問題。
...
// (此處省略 Flex Builders 的完整程式碼以保持簡潔，請使用您 V20.1 中的版本)
    ...
    if (stateName === 'course_creation') {
        ...
        switch (stateData.step) {
            case 'await_title':
                ...
                return push(userId, {type: 'text', text: `課程標題：「${text}」\n\n請問課程固定在每週の哪一天？`, quickReply: { items: weekdayButtons }});
            case 'await_time':
