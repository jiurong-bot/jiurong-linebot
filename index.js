  ...
  if (pendingCourseCancellation[userId]) {
    ...
    switch (state.step) {
      case 'await_student_search':
        // 🟢 DEFER: For student search in manual adjust flow
    ...
    // 🟢 DEFER: Main student search result flow
      ...
      return reply(replyToken, flexMenu);
        ...
        (async () => {
          ...
          try {
              ...
              await push(userId, { type: 'flex', altText: '活動商城', contents: { type: 'carousel', contents: productBubbles.slice(0, 10) } });
          } catch (err) {
...
app.listen(PORT, async () => {
  ...
  console.log(`Bot 版本: V15.9 (穩定性強化)`);
