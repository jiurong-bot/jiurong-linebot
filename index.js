...
//               📋 快速選單定義
// =====================================
const studentMenu = []; // 移除預約課程、我的課程、點數管理，只保留 Rich Menu
