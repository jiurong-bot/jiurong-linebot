...
async function handleProductActions(action, data, user) {
    ...
    switch (action) {
        ...
        case 'product_creation_add_another_variant': {
            ...
            state.step = 'await_variant_combination';
            state.currentVariant = {}; // 準備一個新的空物件給下一輪使用
