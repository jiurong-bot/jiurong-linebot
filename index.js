  ...
  if (text === COMMANDS.STUDENT.MY_COURSES) {
      try {
          ...
          const courseItems = myCourses.slice(0, 10).map(c => {
              ...
              const statusColor = isBooked ? '#1a759f' : '#ff9e00';
              const waitingPositionText = isBooked ? '' : `候補順位: 第 ${c.waiting.indexOf(userId) + 1} 位`;
