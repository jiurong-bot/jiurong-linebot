...
// case 'await_image_url': ... 替換成以下內容 ...
  ...
  if (pendingCourseCancellation[userId]) {
    ...
    if (text === COMMANDS.TEACHER.ADD_PRODUCT) {
              ...
              contents: [
                ...
                },
                {
                  ...
                  action: {
                    type: 'message',
                    label: '➕ 上架新商品',
                    text: COMMANDS.TEACHER.ADD_PRODUCT
                  }
                },
                {
                  type: 'button',
                  ...
                  action: {
                    type: 'postback',
                    label: '🛒 管理販售中商品',
                    data: 'action=view_products&filter=available' // 帶上篩選條件
                  }
                },
                {
                  type: 'button',
                  ...
                  action: {
                    type: 'postback',
                    label: '📦 管理已下架商品',
                    data: 'action=view_products&filter=unavailable' // 帶上篩選條件
                  }
                },
                {
                  type: 'separator'
                ...
                },
                {
                  ...
                  action: {
                    type: 'message',
                    label: '📋 查看待處理訂單',
                    text: COMMANDS.TEACHER.PENDING_SHOP_ORDERS
                  }
                }
              ]
            }
        ...
        return showProductManagementList(replyToken, 1, 'available'); // 預設顯示販售中
...
// [修改] 顯示商品管理列表 (for Teacher) - 為其增加 hero 圖片區塊
...
app.listen(PORT, async () => {
  ...
  console.log(`Bot 版本: V21.0 (商城管理介面優化)`); // [修改] 更新版本號
