...
const COMMANDS = {
  ...
  TEACHER: {
    COURSE_MANAGEMENT: '@課程管理',
      ADD_COURSE_SERIES: '@新增課程系列', // [V22.0 新增]
      MANAGE_OPEN_COURSES: '@管理已開課程', // [V22.0 新增]
    POINT_MANAGEMENT: '@點數管理',
      PENDING_POINT_ORDERS: '@待確認點數訂單', // [V22.0 新增]
      MANUAL_ADJUST_POINTS: '@手動調整點數',
    STUDENT_MANAGEMENT: '@學員管理',
      SEARCH_STUDENT: '@查詢學員', // [V22.0 新增]
      VIEW_MESSAGES: '@查看未回覆留言', // [V22.0 新增]
    ANNOUNCEMENT_MANAGEMENT: '@公告管理',
      ADD_ANNOUNCEMENT: '@頒佈新公告',
      DELETE_ANNOUNCEMENT: '@刪除舊公告',
    SHOP_MANAGEMENT: '@商城管理',
      ADD_PRODUCT: '@上架新商品',
      VIEW_PRODUCTS: '@商品管理', // 此指令現在由更精細的指令取代
      MANAGE_AVAILABLE_PRODUCTS: '@管理販售中商品', // [V22.0 新增]
      MANAGE_UNAVAILABLE_PRODUCTS: '@管理已下架商品', // [V22.0 新增]
      SHOP_ORDER_MANAGEMENT: '@訂單管理', // [V22.0 新增]
    REPORT: '@統計報表',
      COURSE_REPORT: '@課程報表',
      ORDER_REPORT: '@訂單報表',
      POINT_REPORT: '@點數報表',
    // --- 以下為舊指令，保留相容性或改為內部觸發 ---
    ADD_COURSE: '@新增課程', // 將改由 ADD_COURSE_SERIES 觸發
    CANCEL_COURSE: '@取消課程',
    COURSE_LIST: '@課程列表',
    PENDING_ORDERS: '@待確認清單', // 將改由 PENDING_POINT_ORDERS 觸發
  ...
  STUDENT: {
    ...
    CONTACT_US: '@聯絡我們',
    // --- 子選單指令 ---
    VIEW_SHOP_PRODUCTS: '@瀏覽商品', // [V22.0 新增]
    EXCHANGE_HISTORY: '@兌換紀錄', // [V22.0 新增]
    CHECK_POINTS: '@查看剩餘點數', // [V22.0 新增]
    BUY_POINTS: '@購買點數',
        ...
        contents: {
            ...
            body: {
                ...
                contents: [
                    ...
                    { type: 'text', text: '購買後請至「點數管理」回報匯款資訊', size: 'xs', color: '#aaaaaa', align: 'center', margin: 'md', wrap: true }
                ]
            }
        }
    };
...
// [V22.0] 函式重構：此函式現在用於產生學員的「點數管理」子選單卡片
    ...
    return {
        ...
        contents: {
            ...
            header: {
                ...
                layout: 'vertical',
                contents: [
                    { type: 'text', text: '💎 點數管理', color: '#ffffff', weight: 'bold', size: 'lg' }
                ],
                backgroundColor: '#34A0A4',
                paddingBottom: 'lg',
                paddingTop: 'lg'
            ...
            footer: {
                ...
                contents: [
                    ...
                    {
                        type: 'button', style: 'secondary', height: 'sm',
                        action: { type: 'message', label: '📜 查詢購點紀錄', text: COMMANDS.STUDENT.PURCHASE_HISTORY }
                    }
                ]
            }
        }
...
async function showCourseSeries(replyToken, page = 1) {
    ...
    try {
        ...
        const addCourseBubble = { type: 'bubble', body: { type: 'box', layout: 'vertical', paddingAll: 'xxl', contents: [{ type: 'box', layout: 'vertical', contents: [{ type: 'text', text: '+', size: 'xxl', weight: 'bold', color: '#CCCCCC', align: 'center' }, { type: 'text', text: '新增課程系列', size: 'md', weight: 'bold', color: '#AAAAAA', align: 'center', margin: 'md' }], justifyContent: 'center', alignItems: 'center', height: '150px' }], }, action: { type: 'message', label: '新增課程系列', text: COMMANDS.TEACHER.ADD_COURSE_SERIES } };

        if (pageSeries.length === 0 && page === 1) {
            const introText = '目前沒有任何進行中的課程系列。點擊卡片以新增。';
        ...
        const message = { type: 'flex', altText: '課程管理選單', contents: { type: 'carousel', contents: courseBubbles } };
    ...
    if (text === COMMANDS.TEACHER.COURSE_MANAGEMENT) {
        const menu = {
            ...
            contents: {
                ...
                body: { type: 'box', layout: 'vertical', spacing: 'md', paddingAll: 'lg',
                    contents: [
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '➕ 新增課程系列', text: COMMANDS.TEACHER.ADD_COURSE_SERIES }},
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '⚙️ 管理已開課程', text: COMMANDS.TEACHER.MANAGE_OPEN_COURSES }}
                    ]
                }
            }
        };
        ...
        const menu = {
            ...
            contents: {
                ...
                body: { type: 'box', layout: 'vertical', spacing: 'md', paddingAll: 'lg',
                    contents: [
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '✅ 確認處理訂單', text: COMMANDS.TEACHER.PENDING_POINT_ORDERS } },
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '✍️ 手動調整點數', text: COMMANDS.TEACHER.MANUAL_ADJUST_POINTS } }
                    ]
                }
            }
        };
        ...
        const menu = {
            ...
            contents: {
                ...
                body: { type: 'box', layout: 'vertical', spacing: 'md', paddingAll: 'lg',
                    contents: [
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '🔍 查詢學員', text: COMMANDS.TEACHER.SEARCH_STUDENT } },
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '💬 查看未回覆留言', text: COMMANDS.TEACHER.VIEW_MESSAGES } }
                    ]
                }
            }
        };
...
// Part 7 of 8
        ...
        const menu = {
            ...
            contents: {
                ...
                body: { type: 'box', layout: 'vertical', spacing: 'md', paddingAll: 'lg',
                    contents: [
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '➕ 頒佈新公告', text: COMMANDS.TEACHER.ADD_ANNOUNCEMENT } },
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '🗑️ 刪除舊公告', text: COMMANDS.TEACHER.DELETE_ANNOUNCEMENT } }
                    ]
                }
            }
        };
          ...
          contents: {
            ...
            body: {
              ...
              contents: [
                ...
                { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '🛒 管理販售中商品', text: COMMANDS.TEACHER.MANAGE_AVAILABLE_PRODUCTS } },
                { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '📦 管理已下架商品', text: COMMANDS.TEACHER.MANAGE_UNAVAILABLE_PRODUCTS } },
                { type: 'separator', margin: 'md'},
                { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '📋 查看待處理訂單', text: COMMANDS.TEACHER.SHOP_ORDER_MANAGEMENT } }
              ]
            }
          }
        };
        ...
        const reportMenu = {
            ...
            contents: {
                ...
                body: { type: 'box', layout: 'vertical', spacing: 'md', paddingAll: 'lg',
                    contents: [
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '📈 課程報表', text: COMMANDS.TEACHER.COURSE_REPORT } },
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '💰 訂單報表', text: COMMANDS.TEACHER.ORDER_REPORT } },
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '💎 點數報表', text: COMMANDS.TEACHER.POINT_REPORT } }
                    ]
                }
            }
        };
...
async function handleStudentCommands(event, userId) {
  ...
  if (pendingBookingConfirmation[userId]) {
      ...
      return reply(replyToken, '請輸入您想對老師說的話，或點選「取消」。', getCancelMenu());
    } else if (text === COMMANDS.STUDENT.POINTS) {
        const menu = {
            type: 'flex', altText: '點數管理',
            contents: {
                type: 'bubble', size: 'giga',
                header: { type: 'box', layout: 'vertical', contents: [{ type: 'text', text: '💎 點數管理', color: '#ffffff', weight: 'bold', size: 'lg'}], backgroundColor: '#34A0A4', paddingTop: 'lg', paddingBottom: 'lg' },
                body: { type: 'box', layout: 'vertical', spacing: 'md', paddingAll: 'lg',
                    contents: [
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '💰 查看剩餘點數', text: COMMANDS.STUDENT.CHECK_POINTS }},
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '➕ 購買點數', text: COMMANDS.STUDENT.BUY_POINTS }},
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '📜 查詢購點紀錄', text: COMMANDS.STUDENT.PURCHASE_HISTORY }}
                    ]
                }
            }
        };
        return reply(replyToken, menu);
    } else if (text === COMMANDS.STUDENT.CHECK_POINTS) {
        ...
        const menu = {
            ...
            contents: {
                ...
                body: { type: 'box', layout: 'vertical', spacing: 'md', paddingAll: 'lg',
                    contents: [
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '🛒 瀏覽商品', text: COMMANDS.STUDENT.VIEW_SHOP_PRODUCTS }},
                        { type: 'button', style: 'secondary', height: 'sm', action: { type: 'message', label: '📜 我的兌換紀錄', text: COMMANDS.STUDENT.EXCHANGE_HISTORY }}
                    ]
                }
            }
        };
...
app.listen(PORT, async () => {
  ...
  console.log(`Bot 版本: V22.0 (介面一致性重構)`); // [V22.0] 更新版本號
...
async function handleEvent(event) {
    ...
    if (event.type === 'message' && event.message.type === 'text') {
        ...
        const newFlowActions = ['run_command', 'list_teachers_for_removal', 'generate_report', 'add_course_start', 'manage_available_products', 'manage_unavailable_products'];
    ...
    if ((event.type === 'message' && (event.message.type === 'text' || event.message.type === 'image'))) {
        ...
        if (user.role === 'teacher') {
          ...
          if (action === 'add_course_start') { // 相容舊 postback
              pendingCourseCreation[userId] = { step: 'await_title' };
              setupConversationTimeout(userId, pendingCourseCreation, 'pendingCourseCreation', (u) => push(u, '新增課程逾時，自動取消。').catch(e => console.error(e)));
              const newPrompt = '請輸入新課程系列的標題（例如：高階空中瑜伽），或按「取消」來放棄操作。';
              return reply(replyToken, newPrompt, getCancelMenu());
