// index.js - V3.13 全面 postback 快速選單版本
const express = require('express');
const fs = require('fs');
const path = require('path');
const line = require('@line/bot-sdk');
require('dotenv').config();
const fetch = require('node-fetch'); // 確保有安裝 node-fetch
...
async function handleStudentCommands(event, userId, db, courses, text) {
  ...
  if (text.startsWith('book_course_')) {// index.js - V3.13 全面 postback 快速選單版本
const express = require('express');
const fs = require('fs');
const path = require('path');
const line = require('@line/bot-sdk');
