                    ...
                    contents: [
                        {
                          ...
                          action: {
                              ...
                              data: `action=view_pending_orders_page&page=1` // [V23.7 Bug修復]
                          }
                        },
                        {
                          type: 'button', style: 'secondary', height: 'sm',
...
app.listen(PORT, async () => {
  try {
    ...
    console.log(`Bot 版本: V23.7 (錯誤修復與排版優化)`); // [V23.7 修改]
...
async function handleEvent(event) {
    ...
    if ((event.type === 'message' && (event.message.type === 'text' || event.message.type === 'image'))) {
        ...
        if (action === 'view_pending_orders' || action === 'view_pending_orders_page') { // [V23.7 Bug修復]
