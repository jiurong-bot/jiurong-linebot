...
async function handleTeacherCommands(event, userId) {
  ...
  } else if (pendingAnnouncementCreation[userId] || pendingAnnouncementDeletion[userId] || pendingMessageSearchQuery[userId] || pendingProductCreation[userId]) {
...
app.listen(PORT, async () => {
  ...
  console.log(`Bot 版本: V15.14 (公告與留言管理)`);
