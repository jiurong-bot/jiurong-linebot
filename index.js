        ...
        case 'book':
            if (text === COMMANDS.STUDENT.CONFIRM_BOOKING) {
                ...
                try {
                    ...
                    const courseForUpdate = await client.query('SELECT students, capacity, time, title FROM courses WHERE id = $1 FOR UPDATE', [state.course_id]);
...
app.listen(PORT, async () => {
  try {
    ...
    console.log(`Bot 版本: V24.0 (訊息佇列架構)`); // [V24.0 修改]
