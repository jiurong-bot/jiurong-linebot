// index.js - V12.1 (重構老師指令以修復重複回覆BUG)
...
async function handleTeacherCommands(event, userId) {
  ...
  if (pendingCourseCancellation[userId]) {
    ...
    return;
  } else if (text === COMMANDS.TEACHER.COURSE_MANAGEMENT || text === COMMANDS.TEACHER.ADD_COURSE) {
      try {
