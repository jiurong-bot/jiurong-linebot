...
async function handlePurchaseFlow(event, userId) {
    ...
    // [修改] 通用取消指令已在 handleEvent 中集中處理，此處無需再判斷
...
app.listen(PORT, async () => {
  ...
  console.log(`Bot 版本: V18.2 (取消機制與環境變數重構)`); // [修改] 更新版本號
