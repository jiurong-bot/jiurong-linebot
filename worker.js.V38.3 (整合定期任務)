...
// [新增] 從 index.js 移轉過來的任務計時器
let lastOrderCancel = 0;
let lastCourseCleanup = 0;


// =======================================================
// [新增] 從 index.js 搬移過來的輔助函式
// =======================================================
...
async function main() {
  console.log('🚀 背景工作程式 (Worker) 已啟動... V38.3 (整合定期任務)');
  while (true) {
    if (isShuttingDown) {
